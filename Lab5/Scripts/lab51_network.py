...
def run():
    ...
    r1.cmd("ip route add 10.10.0.0/24 dev r1-eth0")
    r1.cmd("ip route add 10.10.1.0/24 dev r1-eth1")
    h1.cmd('ip route add default via 10.10.0.10 dev h1-eth0')
    h2.cmd('ip route add default via 10.10.0.10 dev h2-eth0')
    h3.cmd('ip route add default via 10.10.1.10 dev h3-eth0')
